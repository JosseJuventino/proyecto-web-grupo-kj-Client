...
function ProyectsAdmin({ header, rows, showAction, showCheckbox }) {
  ...
  const [fileName, setFileName] = useState(" Reporte de Círculo de estudio");
  ...
  const generatePDF = () => {
    ...
    const titleText = `Reporte de circulo de estudio generado`;
    const titleWidth =
  ...
  return (
    <>
      ...
      <button className="ml-10 mt-4 lg:mt-8 lg:mr-6 bg-black hover:bg-slate-600 text-white font-bold py-2 px-4 rounded">
        Editar
