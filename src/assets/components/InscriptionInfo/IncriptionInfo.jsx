...
function IncriptionInfo() {
  ...
  const aniosCarrera = [
    { value: "0", text: "Seleccione --" },
    { value: "1", text: "Primer año" },
    { value: "2", text: "Segundo año" },
    { value: "3", text: "Tercer año" },
    { value: "4", text: "Cuarto año" },
    { value: "5", text: "Quinto año" },
  ];
  ...
  return (
    <section className="text-center">
      <h1 className="mt-10 mx-5 text-3xl font-bold">
        Inscripción a Círculos de Estudio
      </h1>
      ...
      <div className="flex lg:flex-row flex-col justify-around mt-20 mx-5 gap-20">
        ...
        <div className="flex flex-col ">
          ...
          <p className="m-5">
            CUM de carrera (Adjuntar captura de pantalla del Portal de
            Estudiante)
          </p>
        </div>
      </div>
